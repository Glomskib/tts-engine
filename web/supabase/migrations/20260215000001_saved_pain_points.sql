...
CREATE INDEX idx_saved_pain_points_user_id ON saved_pain_points(user_id);
CREATE INDEX idx_saved_pain_points_times_used ON saved_pain_points(times_used DESC);
