...
- Refreshed: `2026-06-05 13:51 EDT`
- Mission Control: prod `53e6de9`, local/origin `53e6de9` (in sync)
- FlashFlow pre-publish: prod `390f094`, local/origin `390f094` (in sync)
...
## Last refreshed: 2026-06-05 13:51 EDT

## Current deploy truth at snapshot time

- **Mission Control:** live match. At snapshot time, local/origin/prod were `53e6de9` and production health reported `53e6de9`.
- **FlashFlow:** deploy pipe is healthy. At snapshot time before this public brief was republished, local/origin/prod were `390f094` and production health reported `390f094`. Because this brief is hosted by FlashFlow, every public context refresh creates the next SHA; the updater verifies final post-publish `/api/health` before exiting.
