...
CREATE INDEX IF NOT EXISTS idx_transcribe_usage_ip_date ON transcribe_usage (ip, created_at);
CREATE INDEX IF NOT EXISTS idx_transcribe_usage_user_date ON transcribe_usage (user_id, created_at);
