...
export const upgradeNudgeEmails = [
  {
    ...
    getHtml: (data: UpgradeNudgeEmailData) => emailWrapper(`
      ...
      <p>&bull; <strong>20+ creator personas</strong> &mdash; more variety, better hooks</p>
    ...
    getHtml: (data: UpgradeNudgeEmailData) => emailWrapper(`
      ...
      <table style="width: 100%; border-collapse: collapse; margin: 16px 0;">
        ...
        <tr style="border-bottom: 1px solid #3F3F46;">
          ...
          <td style="padding: 12px 8px; color: #0D9488; font-size: 14px; text-align: center;">All 20+</td>
        </tr>
        <tr style="border-bottom: 1px solid #3F3F46;">
  ...
  {
    delay: 7,
    subject: "Your free credits are running low",
    getHtml: (data: UpgradeNudgeEmailData) => emailWrapper(`
      <h1>Don't lose your momentum</h1>
      <p>Hey ${data.userName},</p>
      <p>You've been using FlashFlow for a week now. The creators who stick with it see the best results &mdash; and the ones on Creator Pro see them fastest.</p>
      <p>Here's the truth: <strong>consistency beats talent on TikTok Shop.</strong> Creator Pro gives you the tools to stay consistent without burning out.</p>
      <p>Your free credits won't last forever. Upgrade now and never worry about running out of content ideas again.</p>
      <a href="https://flashflowai.com/upgrade" class="btn">Upgrade to Creator Pro &mdash; $29/mo</a>
      <p style="font-size: 13px; color: #71717A;">Cancel anytime. No contracts.</p>
