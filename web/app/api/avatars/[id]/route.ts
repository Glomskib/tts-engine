/**
 * /api/avatars/[id] — read, update, soft-delete a single avatar.
 */
...
export async function PATCH(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  const allowed = [
    'name','avatar_display_name','niche','personality','target_audience','avatar_appearance',
    'avatar_visual_recipe','avatar_visual_reference_url','heygen_custom_avatar_id',
    'voice_provider','voice_clone_id','tone_descriptor','prohibited_phrases','preferred_phrases',
    'knowledge_bank','setup_status','test_render_url','avatar_video_style',
  ];
