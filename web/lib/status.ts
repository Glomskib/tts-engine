...
const STATUS_CONFIG: Record<RecordingStatus, StatusConfig> = {
  NEEDS_SCRIPT:         { label: 'Write Script',        bg: 'bg-red-500/10',     text: 'text-red-400',     dot: 'bg-red-400',     emoji: '📝', boardBg: 'bg-red-500/10 border-red-500/20' },
  ...
  NOT_RECORDED:         { label: 'Ready to Record',     bg: 'bg-zinc-500/10',    text: 'text-zinc-400',    dot: 'bg-zinc-400',    emoji: '📄', boardBg: 'bg-zinc-500/10 border-zinc-500/20' },
