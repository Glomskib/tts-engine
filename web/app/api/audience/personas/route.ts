...
export async function POST(request: Request) {
  ...
  // Plan gate: custom personas require a paid plan (Creator Pro or higher)
  const gateResult = await canPerformGatedAction(authContext.user.id, !!authContext.isAdmin);
