...
## Last refreshed: 2026-05-10 ~6:22pm ET
...
- TCG Buying Group BuybackOS evaluation saved to `~/Documents/MacBook Pro VAULT/10-Projects/TCG-on-BuybackOS-eval-2026-05-10.md`. Recommendation: extend BuybackOS with a narrow Brandon-only TCG operator ledger instead of building from scratch. Estimated 3-5 build days for the first useful MVP.
...
- **TCG Buying Group:** BuybackOS is the recommended base. Next unblocked build: add an isolated TCG operator ledger module in BuybackOS (`tcg_members`, append-only ledger, supplier invoices, group buys, allocations, member statements) and test it with 5 seeded members. Do not enable live Stripe pricing or public registration without Brandon approval.
