...
- FlashFlow: live at `5938667` before this board refresh. This file lives inside FlashFlow, so every board/session-brief publish creates the next SHA; always verify `https://flashflowai.com/api/health` after pushing docs.
...
- Latest approval cockpit: `/Users/makingmilesmatter/Documents/MacBook Pro VAULT/10-Projects/this-week-approval-cockpit-2026-05-23-163237/approval-cockpit.html`
- Latest HHH approval room: `none found`
- Latest HHH approval room brief: `none found`
- Latest HHH approval room manifest: `none found`
...
- **HHH approval room:** sponsor, Facebook, and route review surfaces are consolidated at `none found` with the short brief at `none found`. The latest one-command status handoff is `/Users/makingmilesmatter/Documents/MacBook Pro VAULT/10-Projects/HHH-2026-approval-room-status-2026-05-23-163059.md`. The manifest is `none found` and shows zero emails/posts/uploads/Shopify/DNS/payment/merge/delete actions.
