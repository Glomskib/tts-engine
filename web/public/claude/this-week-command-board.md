...
- FlashFlow: deploy pipe is healthy; the checker saw `d947379` before this docs refresh. Check `https://flashflowai.com/api/health` after each brief push because the docs live inside FlashFlow.
...
5. HHH Facebook batch: approve, edit, or hold the June 8-July 7 clean v2 posts. Review file: `~/Documents/MacBook Pro VAULT/10-Projects/HHH-2026-facebook-clean-v2-review-2026-05-16.md`; preflight: `~/Documents/MacBook Pro VAULT/10-Projects/HHH-2026-facebook-clean-v2-preflight-2026-05-16.md`. Verification passed: zero risk-scan hits and no posts scheduled/published.
