...
## Authoritative Update - 2026-05-17 12:59am ET
...
- FlashFlow deploy pipe is healthy at `0a24c20` before this docs refresh after the avatar API error-code fix and docs refresh. Public-doc refreshes create a newer FlashFlow health SHA, so verify `/api/health` against local HEAD after every push.
